...
We would ❤️ for you to contribute to Getapp-ui Design and help make it better! We want contributing to Getapp-ui Design to be fun, enjoyable, and educational for anyone and everyone. All contributions are welcome, including issues, new docs as well as updates and tweaks, blog posts, workshops, and more.

## How to Start?

If you are worried or don’t know where to start, check out our next section explaining what kind of help is needed and where you can get involved. You can reach out with questions on our [Discord](https://khulnasoft.com/discord) server. You can also submit an issue and a maintainer can guide you!
...
- [`apps/getapp-ui`](apps/getapp-ui) - Getapp-ui Design style library

```
├── apps
│   └── getapp-ui                                    //Getapp-ui Design repo
│       ├── public
...
Getapp-ui Design makes use of the [astro.build](https://astro.build/) library.
...
After installing [Node.js](https://nodejs.org/), run the following commands to setup Getapp-ui Design:

```sh
git clone https://github.com/khulnasoft/getapp-ui.git
cd getapp-ui
npm install
```
...
This command can be used to develop Getapp-ui Design components with an auto-reload preview exposed at [http://localhost:3333](http://localhost:3333).
...
You can build Getapp-ui Design, including all dependencies in [`packages/`](packages/), with:
...
Please avoid introducing new dependencies to Getapp-ui Design without consulting the team. New dependencies can be very helpful but also introduce new security and privacy issues, complexity, and impact the total page size and load time.

Adding a new dependency should have vital value on the product with minimum possible risk.

## Introducing New Features

We would 💖 you to contribute to Getapp-ui Design, but we would also like to make sure Getapp-ui Design is as great as possible and loyal to its vision and mission statement 🙏.

For us to find the right balance, please open an issue explaining your ideas before introducing

This is important for Getapp-ui Design maintainers to discuss the feature's design and architecture to help the contribution fit in organically in the codebase. Some bigger features might need to go through our RFC process.

## Other Ways to Help

Pull requests are great, but there are many other areas where you can help Getapp-ui Design.

### Sending Feedbacks & Reporting Bugs

Sending feedback is a great way for us to understand your different use cases of Getapp-ui Design better. If you had any issues, bugs, or want to share about your experience, feel free to do so on our GitHub issues page or at our [Discord channel](https://discord.gg/GSeTUeA).

### Submitting New Ideas

If you think Getapp-ui Design could use a new feature, please open an issue on our GitHub repository, stating as much information as you can think about your new idea and it's implications. We would also use this issue to gather more information, get more feedback from the community, and have a proper discussion about the new feature.
...
Help us keep Getapp-ui Design open and inclusive. Please read and follow our [Code of Conduct](https://github.com/khulnasoft/.github/blob/main/CODE_OF_CONDUCT.md).

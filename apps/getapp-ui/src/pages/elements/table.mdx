---
title: Table
description: Tables are used throughout the GetApp console to organize and display data.
---
...
In the GetApp console, we use three styles of tables:
...
| Class                    | Type                 |                                                                                  |
| ------------------------ | -------------------- | -------------------------------------------------------------------------------- |
| `is-remove-outer-styles` | Without Outer Styles | Secondary table - in the GetApp console used mostly inside a card or a wizard. |

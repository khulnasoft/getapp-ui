...
In the GetApp console, we use four types of buttons:
...
| class    | Type   |                                                                                                                                                     |
| -------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| -        | Medium | The most commonly used size (default size). Getapp-ui Design's input fields are 40px tall, which is why we use medium size buttons next to input fields. |
...
Use icons in cases where they have a strong universal meaning and aid in the recognition of a button. In GetApp, the icon is placed on the left by default.

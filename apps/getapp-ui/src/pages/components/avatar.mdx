...
In the GetApp console, apart from empty avatars and default gray-colored avatars, avatars can use five more colors:
...
<Preview center>
  ...
  <div class="avatar is-color-getapp-ui">aa</div>

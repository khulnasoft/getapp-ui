...
In the GetApp console we use six classes to set system colors based on states:
...
| `u-color-text-getapp-ui`     | `color: hsl(var(--color-getapp-ui-text))!important;`     |
...
<Preview center>
  ...
  <div class="icon-check u-color-text-getapp-ui"></div>
</Preview>

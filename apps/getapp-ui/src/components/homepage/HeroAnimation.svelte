<script lang="ts">
  ...
  <div class="u-inline-flex u-cross-center u-gap-12">
    ...
    `<td class="table-col" data-title="Name">
  <div class="u-inline-flex u-cross-center u-gap-12">
    <span class="avatar is-color-getapp-ui">RR</span>
    <!-- ... -->
    </div></td>
    <!-- ... -->
    <td class="table-col" data-title="Name">
  ...
  <div class="wrapper">
    ...
    >
      ...
      <defs>
        ...
        <linearGradient
          id="paint24_linear_2_88_getapp-ui"
          x1="482.991"
          y1="61.2795"
          x2="485.819"
          y2="198.661"
    ...
    <div class="avatar avatar-1 is-color-getapp-ui">RR</div>
      ...
      <table class="table is-selected-columns-mobile">
        ...
        <tbody class="table-tbody">
          <tr class="table-row">
            <td class="table-col" data-title="Name">
              <div class="u-inline-flex u-cross-center u-gap-12">
                <div class="avatar" class:is-color-getapp-ui={$html.index > 1}>
                  RR
                </div>
                <div>
                  <span class="text u-bold">Ronald Richards</span>
                  <span class="text">ronald@khulnasoft.com</span>
                </div>
              </div>
            </td>
          </tr>
            ...
            <td class="table-col" data-title="Name">
              <div class="u-inline-flex u-cross-center u-gap-12">
                ...
                <div>
                  ...
                  <span class="text">jenny@khulnasoft.com</span>
                </div>
              </div>
            </td>
          </tr>
...
<style lang="scss">
  ...
  .color-card {
    ...
    .thumb {
      background-color: var(--getapp-ui-color);
      width: 16px;
      height: 16px;
      border-radius: 3px;
    }
  ...
  .dashboard {
    ...
    @keyframes line-color {
      to {
        stop-color: var(--getapp-ui-color);
        stroke: var(--getapp-ui-color);
        stroke-opacity: 0.7;
      }
    }

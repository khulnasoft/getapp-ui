<script lang="ts">
  ...
  const codes: Record<string, string | Array<{ name: string; code: string }>> =
    {
      card: `<article class="card u-text-center"><img class="avatar is-size-x-large u-margin-inline-auto" src="https://source.unsplash.com/LaK153ghdig/132x132" alt="Kristin Watson" width="66" height="66" />  <h3 class="body-text-2 u-bold u-margin-block-start-16">Kristin Watson</h3>  <p class="u-margin-block-start-4 u-color-text-gray">    kristin.watson@khulnasoft.com  </p>  <button class="button u-margin-inline-auto u-margin-block-start-24">    <span class="text">Edit profile</span>  </button></article>`,
      form: `<div class="card">
            ...
            <form class="form u-margin-block-start-24">
              <ul class="form-list">
                ...
                <li class="form-item">
                  ...
                  <div class="input-text-wrapper">
                    <input type="email" class="input-text u-padding-inline-end-56" placeholder="kristin@khulnasoft.com" name="email"/>
                  </div>
                </li>
              </ul>
